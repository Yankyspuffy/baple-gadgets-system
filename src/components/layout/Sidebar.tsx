...
import { LayoutDashboard, Package, History, ClipboardList, Sparkles } from 'lucide-react'
    ...
    <div className="flex h-screen w-64 flex-col bg-zinc-950 border-r border-zinc-800 text-zinc-100">
      ...
      <div className="flex-1 py-4">
        <nav className="space-y-1 px-3">
          ...
          <Link href="/assistant" className="flex items-center rounded-md px-3 py-2 text-sm font-medium text-zinc-300 hover:bg-zinc-900 hover:text-white transition-colors mt-4 bg-indigo-500/10 text-indigo-400 hover:text-indigo-300 hover:bg-indigo-500/20">
